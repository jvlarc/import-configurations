    ...
    data: {
      ...
      attributes: {
        properties: {
          ...
          residential_status: verificationData.residential_status || '',
          nationality: verificationData.nationality || '',
          is_foreigner: verificationData.is_foreigner ? 'true' : 'false',
          passport_number: verificationData.passport_number || '',
          pass_status: verificationData.pass_status || '',
        },
      },
    },
  };
